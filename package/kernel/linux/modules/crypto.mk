...
define KernelPackage/crypto-blake2b
  ...
  FILES:=$(LINUX_DIR)/crypto/blake2b_generic.ko@lt7.2 \
	$(LINUX_DIR)/lib/crypto/libblake2b.ko@ge7.2 \
	$(LINUX_DIR)/crypto/blake2b.ko@ge7.2
  AUTOLOAD:=$(call AutoLoad,09,blake2b_generic@lt7.2 blake2b@ge7.2)
  $(call AddDepends/crypto)
endef
...
define KernelPackage/crypto-sha3
  ...
  FILES:=$(LINUX_DIR)/crypto/sha3_generic.ko@lt7.2 \
	$(LINUX_DIR)/lib/crypto/libsha3.ko@ge7.2 \
	$(LINUX_DIR)/crypto/sha3.ko@ge7.2
  AUTOLOAD:=$(call AutoLoad,09,sha3_generic@lt7.2 sha3@ge7.2)
  $(call AddDepends/crypto)
endef
